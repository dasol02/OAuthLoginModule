...
#define kServiceAppUrlScheme    kAuthNaverServiceAppUrlScheme
#define kConsumerKey            kAuthNaverConsumerKey
#define kConsumerSecret         kAuthNaverConsumerSecret
#define kServiceAppName         kAuthNaverServiceAppName
